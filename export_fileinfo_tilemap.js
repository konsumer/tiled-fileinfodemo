...
const customTileMapFormat = {
  ...
  write: function (map, fileName) {
    const info = {
      ...
      fileTimeAccess: FileInfo.fileTime(fileName, 0),
      fileTimeBirth: FileInfo.fileTime(fileName, 1),
      fileTimeMetaChange: FileInfo.fileTime(fileName, 2),
      fileTimeModification: FileInfo.fileTime(fileName, 3),
